            ...
            <div class="row gx-5">
              ...
              <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea type="text" rows="5" class="form-control bg-disabled"disabled>{{ $admin->address }}</textarea>
                </div>
                <div class="form-group">
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="mt-3 d-flex flex-column justify-content-center align-items-center">
                    @if($admin->photo)
                    <img src="{{ asset('storage/'.$admin->photo) }}" class="w-100 h-100 rounded-pill" alt="Product Image Preview"
