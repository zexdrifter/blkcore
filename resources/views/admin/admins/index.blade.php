      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
              <h4 class="card-title mb-2">Admin</h4>
              <p class="card-description mb-0">
                Daftar admin yang telah ditambahkan
              </p>
            </div>
            <button class="btn btn-dark btn-icon-text" data-toggle="modal" data-target="#addAdminModal">
          ...
          <div class="d-flex justify-content-end align-items-end mb-2">
            <form action="" class="input-group" style="max-width: 300px;">
              <input type="text" name="search" value="{{ Request::get('search') }}" class="form-control"
                placeholder="Search admin" aria-label="Search admin">
              ...
              <tbody>
                @foreach ($admins as $row)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('admin.admins.show', $row->id) }}" class="btn btn-sm btn-dark">Lihat</a>
                      <a href="{{ route('admin.admins.edit', $row->id) }}" class="btn btn-sm btn-warning">Edit</a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-dark">Simpan Admin</button>
          </div>
        </div>
      </div>
    </form>
  ...
  @push('scripts')
    <script>
      ...
      function confirmDelete(id, name) {
        Swal.fire({
          title: 'Hapus Admin',
          text: "Apakah Anda yakin ingin menghapus admin '" + name + "' ini?",
          icon: 'warning',
